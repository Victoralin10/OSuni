...
public class StatisticTest {
    ...
    public void testUniform() {
        ...
        for (int i = 0; i < 200; i++) {
            ...
            Assert.assertTrue("Value generated out of range.", v >= -20 && v <= 100);
        }
    }
    ...
    public void testExponential() {
        ...
        for (int i = 0; i < 200; i++) {
            ...
            Assert.assertTrue("Value generated out of range.", v >= 0);
        }
    }
    ...
    public void testList() {
        ...
        for (int i = 0; i < 20; i++) {
            ...
            Assert.assertTrue("Value not contains list", v > 0 && v <= 10);
        }
    }
}
